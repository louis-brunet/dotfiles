...
class CompletionService:
    ...
    async def generate(
        ...
        # Set pending request
        runner_request = CompletionRunnerRequest(request=request, request_id=request_id.int)
        ...
        try:
            ...
            logger.info(f"Requested processing finished in {request_processing_time:.3f}s.")
